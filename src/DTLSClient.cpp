...
DTLSClient::DTLSClient(const std::string& bridge_ip, const std::string& username, const std::string& clientkey, const std::string& area_id)
    : bridge_ip_(bridge_ip), username_(username), area_id_(area_id) {
